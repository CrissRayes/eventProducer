...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { audience: @concert.audience, concert_date: @concert.concert_date, group_id: @concert.group_id } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { audience: @concert.audience, concert_date: @concert.concert_date, group_id: @concert.group_id } }
